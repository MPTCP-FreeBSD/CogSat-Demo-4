function DeakinCogSatSimulatorV9
    ...
    % KPI Panels
    panelWidth = 520; panelHeight = 250; panelBottom = 80; gap = 20;
    ...
    kpi4 = uipanel(fig, 'Title','Mean SINR for GEO Users', 'FontSize', 18, 'Position',[gap*2 + panelWidth panelBottom panelWidth panelHeight]);
